...
#endif
extern DLL_VARIABLE size_t iconv (iconv_t cd, const char* * inbuf, size_t *inbytesleft, char* * outbuf, size_t *outbytesleft);
...
/* Sets the original and the current installation prefix of the package.
   ...
   instead of "/").  */
extern DLL_VARIABLE void libiconv_set_relocation_prefix (const char *orig_prefix,
